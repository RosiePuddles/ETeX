...
doc.add(Text('The \\verb|generate_TeX| method is used to generate .tex files, and optionally generate .pdf files.'
             ...
             'formatted version of the value for the title given on instantiation of a new instance of the \\verb|Document| class. Any of the following characters are removed:'))
...
doc.add(Text('The \\verb|Table| class '))
#################################################################################################################################################################################################
